...
pub mod regs {
    ...
    impl Obr {
        ...
        #[doc = "NRST pin mode currently in effect (mirror of OB.USER.RST_MODE)."]
        #[inline(always)]
        pub const fn cfgrstt(&self) -> super::vals::RstPinMode {
            let val = (self.0 >> 5usize) & 0x03;
            super::vals::RstPinMode::from_bits(val as u8)
        }
        #[doc = "NRST pin mode currently in effect (mirror of OB.USER.RST_MODE)."]
        #[inline(always)]
        pub fn set_cfgrstt(&mut self, val: super::vals::RstPinMode) {
...
pub mod vals {
    ...
    #[doc = "NRST pin behavior at power-on. Only the two encodings below are defined; other values are reserved."]
    #[repr(u8)]
    #[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
    pub enum RstPinMode {
        #[doc = "Enable the external reset pin in its NRST function."]
        NRST = 0x0,
        _RESERVED_1 = 0x01,
        _RESERVED_2 = 0x02,
        #[doc = "Disable NRST and use the pin as a general-purpose I/O (PA21/PC3/PB7 depending on package)."]
        GPIO = 0x03,
    }
    impl RstPinMode {
        #[inline(always)]
