...
#[path = "../registers/adc_v00x.rs"]
pub mod adc;
#[path = "../registers/afio_v00x.rs"]
pub mod afio;
#[path = "../registers/dma_v1.rs"]
pub mod dma;
#[path = "../registers/exten_v00x.rs"]
pub mod exten;
...
pub mod pfic;
#[path = "../registers/pwr_v00x.rs"]
pub mod pwr;
#[path = "../registers/rcc_v00x.rs"]
pub mod rcc;
#[path = "../registers/sltm_v00x.rs"]
pub mod sltm;
