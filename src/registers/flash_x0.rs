...
pub(crate) static REGISTERS: IR = IR {
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cfgrstt",
                    description: Some(
                        "NRST pin mode currently in effect (mirror of OB.USER.RST_MODE).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 5,
    ...
    enums: &[
        ...
        Enum {
            name: "RstPinMode",
            description: Some(
                "NRST pin behavior at power-on. Only the two encodings below are defined; other values are reserved.",
            ),
            bit_size: 2,
            variants: &[
                EnumVariant {
                    name: "NRST",
                    description: Some(
                        "Enable the external reset pin in its NRST function.",
                    ),
                    value: 0,
                },
                EnumVariant {
                    name: "GPIO",
                    description: Some(
                        "Disable NRST and use the pin as a general-purpose I/O (PA21/PC3/PB7 depending on package).",
                    ),
                    value: 3,
                },
            ],
