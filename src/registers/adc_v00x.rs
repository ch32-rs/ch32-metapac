    ...
    blocks: &[
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "wdtr",
                    description: Some("ADC watchdog x threshold register."),
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tkenable",
                    description: Some("Touchkey module enable control."),
                ...
                Field {
                    name: "tkitune",
                    description: Some("Touchkey current regulation."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tgregu",
                    description: Some("External firing events for regular channel transitions."),
                ...
                Field {
                    name: "tginje",
                    description: Some("External trigger events that inject transitions."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "adc_lp",
                    description: Some("ADC low-power mode control bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dutyen",
                    description: Some("ADC clock duty control bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "drven",
                    description: Some("Touchkey multiple masking enable bit."),
                ...
                Field {
                    name: "awd_scan",
                    description: Some("Analog Watchdog sans the enable."),
                ...
                Field {
                    name: "awd0_rst_en",
                    description: Some("Analog Watchdog 0 output reset enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "awd1_rst_en",
                    description: Some("Analog Watchdog 1 output reset enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "awd2_rst_en",
                    description: Some("Analog Watchdog 2 output reset enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "awd0_res",
                    description: Some("Analog Watchdog 0 compares the results."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "awd1_res",
                    description: Some("Analog Watchdog 1 compares the results."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "awd2_res",
                    description: Some("Analog Watchdog 2 compares the results."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "drv_outen",
                    description: Some("Touchkey channel x masking enable."),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "data",
                description: Some("Regular data_converted data."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "tkcharge",
                description: Some("Touch key charge data offset for injected channel x."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 11,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "tkact_dcg",
                description: Some("Touch key start and discharge time register."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 11,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ltr",
                    description: Some("Analog watchdog lower threshold setting value."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "htr",
                    description: Some("Analog watchdog higher threshold setting value."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
