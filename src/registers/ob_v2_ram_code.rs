...
pub(crate) static DESCRIPTOR: IR = IR {
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "RAM_CODE",
                    description: Some(
                        "SRAM/CODE memory allocation. Hardware decodes only bits 6-7; bit 5 is don't-care.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 5,
    ...
    enums: &[
        ...
        Enum {
            name: "RamCodeMode",
            description: Some(
                "SRAM/CODE memory allocation. Hardware treats bit 5 as don't-care, so each listed variant covers two raw encodings.",
            ),
            bit_size: 3,
            variants: &[
                EnumVariant {
                    name: "C128_R64",
                    description: Some(
                        "128 KB code + 64 KB RAM (factory default).",
                    ),
                    value: 0,
                },
                EnumVariant {
