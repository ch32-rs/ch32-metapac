...
pub(crate) static DESCRIPTOR: IR = IR {
    blocks: &[
        Block {
            ...
            extends: None,
            description: Some(
                "Persistent flash configuration — read protection, watchdog mode, low-power reset behavior, USB startup configuration, power-on reset timing, write protection, and two free user-data bytes.",
            ),
            items: &[
                BlockItem {
                    name: "RDPR",
                ...
                BlockItem {
                    name: "USER",
                    description: Some(
                        "User configuration — watchdog mode, stop/standby reset, USB startup state, power-on reset timing.",
                    ),
                    array: None,
                    byte_offset: 0x2,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "WRPR3",
                    description: Some(
                        "Write protection for main-flash sectors 24-31. 1 bit per 4K sector (1 = writable, 0 = protected).",
                    ),
                    array: None,
                    byte_offset: 0xe,
                    inner: BlockItemInner::Register(
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "RDPR",
                    description: Some(
                        "Set UNPROTECTED (0xA5) to allow debug reads. Any other value blocks the debug interface and auto-write-protects pages 0-31 (4K each).",
                    ),
        ...
        FieldSet {
            ...
            extends: None,
            description: Some(
                "Watchdog mode, low-power reset, USB startup, and power-on reset timing.",
            ),
            bit_size: 8,
            fields: &[
                Field {
                ...
                Field {
                    name: "USBDMODE",
                    description: Some(
                        "USB bus speed selected at startup.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
                ...
                Field {
                    name: "USBDPU",
                    description: Some(
                        "USB built-in 1.5 kΩ pull-up resistor state at startup.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
