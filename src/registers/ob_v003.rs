...
pub(crate) static DESCRIPTOR: IR = IR {
    blocks: &[
        Block {
            ...
            extends: None,
            description: Some(
                "Persistent flash configuration — read protection, watchdog mode, NRST pin function, boot source, write protection, and two free user-data bytes.",
            ),
            items: &[
                BlockItem {
                    name: "RDPR",
                ...
                BlockItem {
                    name: "USER",
                    description: Some(
                        "User configuration — watchdog mode, standby reset, NRST pin function, boot source.",
                    ),
                    array: None,
                    byte_offset: 0x2,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "WRPR0",
                    description: Some(
                        "Write protection for main-flash sectors 0-7. 1 bit per 1K sector (1 = writable, 0 = protected).",
                    ),
                    array: None,
                    byte_offset: 0x8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "WRPR1",
                    description: Some(
                        "Write protection for main-flash sectors 8-15. 1 bit per 1K sector (1 = writable, 0 = protected).",
                    ),
                    array: None,
                    byte_offset: 0xa,
                    inner: BlockItemInner::Register(
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "RDPR",
                    description: Some(
                        "Set UNPROTECTED (0xA5) to allow debug reads. Any other value blocks the debug interface and auto-write-protects pages 0-31.",
                    ),
        ...
        FieldSet {
            ...
            extends: None,
            description: Some(
                "Watchdog mode, standby reset, NRST pin function, and boot source.",
            ),
            bit_size: 8,
            fields: &[
                Field {
                ...
                Field {
                    name: "RST_MODE",
                    description: Some(
                        "NRST pin behavior and the glitch-filter window at power-on.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
