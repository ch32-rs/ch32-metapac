...
pub(crate) static DESCRIPTOR: IR = IR {
    blocks: &[
        Block {
            ...
            extends: None,
            description: Some(
                "Persistent flash configuration — read protection, watchdog mode, standby reset, NRST pin function, boot source, write protection, and two free user-data bytes.",
            ),
            items: &[
                BlockItem {
                    name: "RDPR",
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "RST_MODE",
                    description: Some(
                        "NRST pin function and power-on glitch-filter window.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
